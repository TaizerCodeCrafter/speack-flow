...
export const EssentialVerbsManager: React.FC<EssentialVerbsManagerProps> = ({ onShowToast }) => {
  ...
  // Restore 1,000+ Verbs into "Essential Verbs 1"
  const handleRestoreDefaults = () => {
    if (
      window.confirm(
        'Restore the 1,000+ Essential Verbs into "Essential Verbs 1"? Any customized verbs in this pack will be refreshed.'
      )
    ) {
      ...
      onShowToast('Essential Verbs 1 restored with all 1,000+ verbs!');
    }
  };
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-100 pb-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              title="Restore full 1,000+ verbs to Essential Verbs 1"
            ...
            >
              ...
              <span className="hidden sm:inline">Reset 1,000+ Verbs</span>
            </button>
          </div>
        </div>
